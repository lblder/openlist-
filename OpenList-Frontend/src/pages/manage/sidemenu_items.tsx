...
export const side_menu_items: SideMenuItem[] = [
  ...
  // },
  {
    title: "manage.sidemenu.account_management",
    to: "/@manage/account-management",
    icon: BsPersonCircle,
    component: lazy(() => import("./account-management")),
    role: UserRole.GENERAL,
  },
  {
    title: "manage.sidemenu.certificate_management",
    to: "/@manage/certificate-management",
    icon: BsFingerprint,
    component: lazy(() => import("./certificate-management")),
    role: UserRole.GENERAL,
  },
  {
